      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-items-center pt-10">
        <div className="text-center md:text-left md:pl-16">
          ...
          <p style={{ paddingLeft: "10%" }}>
            Welcome to our vibrant and passionate flag football league! We're a
            group of friends who decided to take our love for football to
            another level, creating an exciting space where we could compete,
            build bonds, and make unforgettable memories. This league was born
            out of our collective desire to stay active, embrace the spirit of
            sportsmanship, and nurture our shared love for the game of football.
            ...
            that makes this game so exciting. Whether you're a seasoned veteran,
            a rookie player, or a supportive fan, we're glad you're here. This
            season promises nail-biting matches, sportsmanship at its finest,
            and above all, an amazing time on and off the field. We invite you
            to join us in this journey filled with athletic prowess, teamwork,
            and plenty of thrilling moments. Let's make this season the best one
            yet! Welcome to our league, and here's to many more seasons of
            fantastic flag football!
          </p>
          <br />
        </div>
